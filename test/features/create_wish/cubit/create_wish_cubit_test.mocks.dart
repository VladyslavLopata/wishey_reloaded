...
import 'package:wishey/core/models/wish_list.dart' as _i10;
import 'package:wishey/core/router/auto_route.dart' as _i18;
...
import 'package:wishey/features/create_wish/use_cases/is_wish_valid.dart'
    as _i14;
import 'package:wishey/features/create_wish/use_cases/save_wish.dart' as _i15;
...
class _FakeGlobalKey_9<T extends _i8.State<_i8.StatefulWidget>> extends _i1.Fake
    implements _i8.GlobalKey<T> {}
...
class MockGetViewModelUseCase extends _i1.Mock
    implements _i9.GetViewModelUseCase {
  MockGetViewModelUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i2.LoadedStateViewModel call(_i10.Wish? wish) => (super.noSuchMethod(
...
class MockUpdateFieldUseCase extends _i1.Mock
    implements _i11.UpdateFieldUseCase {
  ...
  @override
  _i12.Future<_i3.ErrorProne<T>> executeErrorProneAsync<T>(
          _i12.Future<T> Function()? function) =>
      (super.noSuchMethod(
              Invocation.method(#executeErrorProneAsync, [function]),
              returnValue:
                  Future<_i3.ErrorProne<T>>.value(_FakeErrorProne_1<T>()))
          as _i12.Future<_i3.ErrorProne<T>>);
}
...
class MockShouldShowSaveButtonUseCase extends _i1.Mock
    implements _i13.ShouldShowSaveButtonUseCase {
...
class MockIsWishValidUseCase extends _i1.Mock
    implements _i14.IsWishValidUseCase {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveWishUseCase extends _i1.Mock implements _i15.SaveWishUseCase {
  MockSaveWishUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i12.Future<_i3.ErrorProne<void>> call(
      ...
      (super.noSuchMethod(
          ...
          as _i12.Future<_i3.ErrorProne<void>>);
}
...
class MockInitFormsStorageUseCase extends _i1.Mock
    implements _i16.InitFormsStorageUseCase {
  MockInitFormsStorageUseCase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  void call({_i10.Wish? wish = const _i10.Wish(topic: r'', title: r'')}) =>
...
class MockGetWishTopicUseCase extends _i1.Mock
    implements _i17.GetWishTopicUseCase {
...
///
/// See the documentation for Mockito's code generation for more information.
class MockAppRouter extends _i1.Mock implements _i18.AppRouter {
  MockAppRouter() {
    _i1.throwOnMissingStub(this);
  }
  ...
  int get stateHash =>
      (super.noSuchMethod(Invocation.getter(#stateHash), returnValue: 0)
          as int);
  @override
  _i8.GlobalKey<_i8.NavigatorState> get navigatorKey =>
      (super.noSuchMethod(Invocation.getter(#navigatorKey),
              returnValue: _FakeGlobalKey_9<_i8.NavigatorState>())
  ...
  _i5.AutoRouteInformationProvider routeInfoProvider(
          {_i8.RouteInformation? initialRouteInformation}) =>
      (super.noSuchMethod(
  ...
  _i5.AutoRouterDelegate declarativeDelegate(
          ...
          _i5.NavigatorObserversBuilder? navigatorObservers =
              _i19.AutoRouterDelegate.defaultNavigatorObserversBuilder}) =>
      (super.noSuchMethod(
  ...
  void dispose() => super.noSuchMethod(Invocation.method(#dispose, []),
      returnValueForMissingStub: null);
  @override
  _i12.Future<T?> pushWidget<T extends Object?>(_i8.Widget? widget,
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<T?>.value()) as _i12.Future<T?>);
  @override
  _i12.Future<T?> pushNativeRoute<T extends Object?>(_i8.Route<T>? route) =>
  ...
  void removeRoute(_i5.RouteData? route, {bool? notify = true}) => super
      .noSuchMethod(Invocation.method(#removeRoute, [route], {#notify: notify}),
          returnValueForMissingStub: null);
  @override
  _i12.Future<T?> push<T extends Object?>(_i5.PageRouteInfo<dynamic>? route,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          Invocation.method(#push, [route], {#onFailure: onFailure}),
          returnValue: Future<T?>.value()) as _i12.Future<T?>);
  @override
  _i12.Future<T?> replace<T extends Object?>(_i5.PageRouteInfo<dynamic>? route,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          Invocation.method(#replace, [route], {#onFailure: onFailure}),
          returnValue: Future<T?>.value()) as _i12.Future<T?>);
  @override
  _i12.Future<void> pushAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          ...
          as _i12.Future<void>);
  @override
  _i12.Future<void> popAndPushAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {dynamic onFailure}) =>
      (super.noSuchMethod(
  ...
  @override
  _i12.Future<void> replaceAll(List<_i5.PageRouteInfo<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
  ...
  void updateDeclarativeRoutes(List<_i5.PageRouteInfo<dynamic>>? routes) =>
      super.noSuchMethod(Invocation.method(#updateDeclarativeRoutes, [routes]),
          returnValueForMissingStub: null);
  @override
  _i12.Future<void> navigateAll(List<_i5.RouteMatch<dynamic>>? routes,
          {_i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
  ...
  _i12.Future<T?> pushAndPopUntil<T extends Object?>(
      ...
      (super.noSuchMethod(
          ...
          returnValue: Future<T?>.value()) as _i12.Future<T?>);
  @override
  _i12.Future<T?> replaceNamed<T extends Object?>(String? path,
          {bool? includePrefixMatches = false,
          _i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
          ...
          returnValue: Future<T?>.value()) as _i12.Future<T?>);
  @override
  _i12.Future<T?> pushNamed<T extends Object?>(String? path,
          {bool? includePrefixMatches = false,
          _i5.OnNavigationFailure? onFailure}) =>
      (super.noSuchMethod(
